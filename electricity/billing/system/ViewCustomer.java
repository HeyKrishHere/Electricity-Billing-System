...
public class ViewCustomer extends JFrame implements ActionListener {
    ...
    ViewCustomer(String meter)
    {
        ...
        /* Now we want to show the information on the basis if meter number but don't have the meter number over here
        so we have to get the meter number from the previous classes*/ 
